...
namespace MyShop.WebUI.Tests.Controllers {
    ...
    public class BasketControllerTest {
        ...
        public void CanCheckoutAndCreateOrder() {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "fakeEmail@gmail.com", ZipCode = "1234" });

            IPrincipal fakeUser = new GenericPrincipal(new GenericIdentity("fakeEmail@gmailcom", "Forms"), null);
